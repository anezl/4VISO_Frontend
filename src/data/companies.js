...
export const TRANSPORT_COMPANIES = [
  { id: 'tc-dhl',      name: 'DHL Supply Chain',         type: 'freight_forwarder', countries: ['DE','NL','BE','FR','ES','IT','PL','UK'], certificates: ['GDP','ISO 9001','ISO 13485','IATA'],   tempCapabilities: ['frozen','cold','ambient'], fragileCapable: true  },
  { id: 'tc-kn',       name: 'Kuehne+Nagel',              type: 'freight_forwarder', countries: ['CH','DE','NL','UK','ES','DK'],           certificates: ['GDP','IATA','ISO 9001','ISO 13485'],   tempCapabilities: ['cold','ambient'],          fragileCapable: true  },
  ...
  { id: 'tc-dsv',      name: 'DSV Panalpina',             type: 'freight_forwarder', countries: ['DK','SE','FI','NL','UK','DE'],           certificates: ['GDP','IATA','ISO 9001'],               tempCapabilities: ['cold','ambient'],          fragileCapable: false },
  ...
  { id: 'tc-ceva',     name: 'Ceva Logistics',            type: 'freight_forwarder', countries: ['NL','FR','BE','ES','IT','DE','UK'],      certificates: ['GDP','IATA','ISO 9001'],               tempCapabilities: ['cold','ambient'],          fragileCapable: false },
  ...
  { id: 'tc-marken',   name: 'Marken',                    type: 'pharma_specialist', countries: ['UK','BE','DE','ES','IT','NL','CH'],      certificates: ['GDP','IATA','ISO 13485'],              tempCapabilities: ['frozen','cold','ambient'], fragileCapable: true  },
  { id: 'tc-wc',       name: 'World Courier',             type: 'pharma_specialist', countries: ['UK','DE','NL','BE','ES','IT','CH','FR'], certificates: ['GDP','IATA','ISO 13485'],              tempCapabilities: ['frozen','cold','ambient'], fragileCapable: true  },
  { id: 'tc-klm',      name: 'KLM Cargo',                 type: 'air_carrier',       countries: ['NL'],                                   certificates: ['IATA','GDP'],                          tempCapabilities: ['cold','ambient'],          fragileCapable: false },
  { id: 'tc-lhc',      name: 'Lufthansa Cargo',           type: 'air_carrier',       countries: ['DE'],                                   certificates: ['IATA','GDP'],                          tempCapabilities: ['cold','ambient'],          fragileCapable: true  },
  { id: 'tc-afc',      name: 'Air France Cargo',          type: 'air_carrier',       countries: ['FR'],                                   certificates: ['IATA','GDP'],                          tempCapabilities: ['ambient'],                 fragileCapable: false },
  { id: 'tc-ibc',      name: 'Iberia Cargo',              type: 'air_carrier',       countries: ['ES'],                                   certificates: ['IATA','GDP','ISO 28000'],              tempCapabilities: ['cold','ambient'],          fragileCapable: false },
  { id: 'tc-swc',      name: 'Swiss WorldCargo',          type: 'air_carrier',       countries: ['CH'],                                   certificates: ['IATA','GDP'],                          tempCapabilities: ['cold','ambient'],          fragileCapable: true  },
  { id: 'tc-sas',      name: 'SAS Cargo',                 type: 'air_carrier',       countries: ['DK','SE','NO'],                         certificates: ['IATA','GDP'],                          tempCapabilities: ['cold','ambient'],          fragileCapable: false },
  { id: 'tc-fai',      name: 'Finnair Cargo',             type: 'air_carrier',       countries: ['FI'],                                   certificates: ['IATA','GDP'],                          tempCapabilities: ['cold','ambient'],          fragileCapable: false },
  { id: 'tc-lot',      name: 'LOT Cargo',                 type: 'air_carrier',       countries: ['PL'],                                   certificates: ['IATA'],                               tempCapabilities: ['ambient'],                 fragileCapable: false },
  { id: 'tc-tap',      name: 'TAP Cargo',                 type: 'air_carrier',       countries: ['PT'],                                   certificates: ['IATA','GDP'],                          tempCapabilities: ['ambient'],                 fragileCapable: false },
  { id: 'tc-iag',      name: 'IAG Cargo',                 type: 'air_carrier',       countries: ['UK','ES'],                              certificates: ['IATA','GDP'],                          tempCapabilities: ['cold','ambient'],          fragileCapable: false },
  { id: 'tc-bru',      name: 'Brussels Airlines Cargo',   type: 'air_carrier',       countries: ['BE'],                                   certificates: ['IATA','GDP'],                          tempCapabilities: ['cold','ambient'],          fragileCapable: false },
  ...
  { id: 'tc-pharmuk',  name: 'PharmUK Ltd',               type: 'pharma_company',    countries: ['UK'],                                   certificates: ['ISO 13485','GDP','IATA'],              tempCapabilities: ['cold','ambient'],          fragileCapable: true  },
  { id: 'tc-biofr',    name: 'BioFrance',                 type: 'pharma_company',    countries: ['FR'],                                   certificates: ['GDP','IATA','ISO 9001'],               tempCapabilities: ['cold','ambient'],          fragileCapable: true  },
...
export const WAREHOUSES = [
  ...
  { id:'wh-fra-02', name:'Kuehne+Nagel Frankfurt',    city:'Frankfurt',  country:'Germany',     company:'Kuehne+Nagel',          type:'warehouse',    certificates:['GDP','ISO 9001','IATA'],      tempZones:[{label:'Cold',min:2,max:8},{label:'Ambient',min:15,max:25}],                                       tempCapabilities:['cold','ambient'],          fragileCapable:true  },
  ...
  { id:'wh-mil-02', name:'Ceva Logistics Milan',      city:'Milan',      country:'Italy',       company:'Ceva Logistics',        type:'warehouse',    certificates:['GDP','ISO 9001','IATA'],      tempZones:[{label:'Cold',min:2,max:8},{label:'Ambient',min:15,max:25}],                                       tempCapabilities:['cold','ambient'],          fragileCapable:false },
  ...
  { id:'wh-cph-01', name:'DSV Copenhagen Pharma',     city:'Copenhagen', country:'Denmark',     company:'DSV Panalpina',         type:'warehouse',    certificates:['GDP','IATA','ISO 9001'],      tempZones:[{label:'Cold',min:2,max:8},{label:'Deep-freeze',min:-20,max:-10}],                                 tempCapabilities:['frozen','cold'],           fragileCapable:false },
  ...
  { id:'wh-lhr-01', name:'Marken London Hub',         city:'London',     country:'UK',          company:'Marken',                type:'warehouse',    certificates:['GDP','IATA','ISO 13485'],      tempZones:[{label:'Cold',min:2,max:8},{label:'Ambient',min:15,max:25},{label:'Deep-freeze',min:-20,max:-10}], tempCapabilities:['frozen','cold','ambient'], fragileCapable:true  },
  { id:'wh-lhr-02', name:'World Courier London',      city:'London',     country:'UK',          company:'World Courier',         type:'warehouse',    certificates:['GDP','IATA','ISO 13485'],      tempZones:[{label:'Cold',min:2,max:8},{label:'Deep-freeze',min:-20,max:-10}],                                 tempCapabilities:['frozen','cold'],           fragileCapable:true  },
...
export const AIRPORTS = [
  { id:'ap-fra', iata:'FRA', name:'Frankfurt Airport',        city:'Frankfurt',  country:'Germany',     company:'Lufthansa Cargo',        type:'airport', certificates:['IATA','GDP'],             coldChain:true,  tempCapabilities:['cold','ambient'], fragileCapable:true  },
  { id:'ap-ams', iata:'AMS', name:'Schiphol Airport',         city:'Amsterdam',  country:'Netherlands', company:'KLM Cargo',              type:'airport', certificates:['IATA','GDP'],             coldChain:true,  tempCapabilities:['cold','ambient'], fragileCapable:false },
  { id:'ap-lhr', iata:'LHR', name:'London Heathrow',          city:'London',     country:'UK',          company:'IAG Cargo',              type:'airport', certificates:['IATA','GDP'],             coldChain:true,  tempCapabilities:['cold','ambient'], fragileCapable:true  },
  { id:'ap-cdg', iata:'CDG', name:'Paris Charles de Gaulle',  city:'Paris',      country:'France',      company:'Air France Cargo',       type:'airport', certificates:['IATA','GDP'],             coldChain:true,  tempCapabilities:['cold','ambient'], fragileCapable:false },
  { id:'ap-mad', iata:'MAD', name:'Madrid Barajas',           city:'Madrid',     country:'Spain',       company:'Iberia Cargo',           type:'airport', certificates:['IATA','GDP'],             coldChain:true,  tempCapabilities:['cold','ambient'], fragileCapable:false },
  { id:'ap-bru', iata:'BRU', name:'Brussels Airport',         city:'Brussels',   country:'Belgium',     company:'Brussels Airlines Cargo', type:'airport', certificates:['IATA','GDP'],             coldChain:true,  tempCapabilities:['cold','ambient'], fragileCapable:false },
  { id:'ap-mxp', iata:'MXP', name:'Milan Malpensa',           city:'Milan',      country:'Italy',       company:'Ceva Logistics',         type:'airport', certificates:['IATA','GDP'],             coldChain:false, tempCapabilities:['ambient'],        fragileCapable:false },
  { id:'ap-zrh', iata:'ZRH', name:'Zurich Airport',           city:'Zurich',     country:'Switzerland', company:'Swiss WorldCargo',       type:'airport', certificates:['IATA','GDP'],             coldChain:true,  tempCapabilities:['cold','ambient'], fragileCapable:true  },
  { id:'ap-cph', iata:'CPH', name:'Copenhagen Airport',       city:'Copenhagen', country:'Denmark',     company:'SAS Cargo',              type:'airport', certificates:['IATA','GDP'],             coldChain:true,  tempCapabilities:['cold','ambient'], fragileCapable:false },
  { id:'ap-hel', iata:'HEL', name:'Helsinki Vantaa',          city:'Helsinki',   country:'Finland',     company:'Finnair Cargo',          type:'airport', certificates:['IATA','GDP'],             coldChain:true,  tempCapabilities:['cold','ambient'], fragileCapable:false },
  { id:'ap-waw', iata:'WAW', name:'Warsaw Chopin',            city:'Warsaw',     country:'Poland',      company:'LOT Cargo',              type:'airport', certificates:['IATA'],                   coldChain:false, tempCapabilities:['ambient'],        fragileCapable:false },
  { id:'ap-bcn', iata:'BCN', name:'Barcelona El Prat',        city:'Barcelona',  country:'Spain',       company:'Iberia Cargo',           type:'airport', certificates:['IATA','GDP','ISO 28000'], coldChain:true,  tempCapabilities:['cold','ambient'], fragileCapable:false },
  { id:'ap-lis', iata:'LIS', name:'Lisbon Humberto Delgado',  city:'Lisbon',     country:'Portugal',    company:'TAP Cargo',              type:'airport', certificates:['IATA','GDP'],             coldChain:true,  tempCapabilities:['cold','ambient'], fragileCapable:false },
]
